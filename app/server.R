...
function(input, output, session) {
    ...
    set_health_tabs_visible <- function(visible) {
        ...
        if (isTRUE(visible)) {
            bslib::nav_show(id = "main_nav", target = "diagnostics", session = session)
            bslib::nav_show(id = "main_nav", target = "nav_status", session = session)
    ...
    output$fund_detail_kpis <- renderUI({
        ...
        div(
            ...
            div(class = 'kpi-card',
                div(class = 'kpi-label', 'Realized gains'),
                div(class = 'kpi-value', money_label(summary$RealizedGains))),
            div(class = 'kpi-card',
